...
class GPT2LM:
    def __init__(self):
        self.tokenizer = transformers.GPT2TokenizerFast.from_pretrained("/data/xxp/models/gpt2")
        self.lm = transformers.GPT2LMHeadModel.from_pretrained("/data/xxp/models/gpt2")
...
class SentenceEncoder:
    def __init__(self, device='cuda'):
        ...
        '''
        self.model = SentenceTransformer('/data/xxp/models/paraphrase-distilroberta-base-v1', device)
